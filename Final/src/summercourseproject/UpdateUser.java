...
public class UpdateUser extends javax.swing.JFrame {
    ...
    public UpdateUser(String search) {
        this.searchText = search;
        this.setTitle("Summer course project");
        this.setResizable(false);
        this.setLocation(500, 200);
        this.setDefaultCloseOperation(UpdateUser.EXIT_ON_CLOSE);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 26, 241, -1));
        ...
        jPanel1.add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 526, -1, 33));

        jButton1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon("E:\\Final\\icons\\back_1.png")); // NOI18N
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 564, -1, -1));
        ...
        try {
            ...
            if (!name.isEmpty() && !pass.isEmpty() && !address.isEmpty() && !city.isEmpty() && !email.isEmpty() && !phone.isEmpty()) {
                if (txt_name.getText().matches("\\d+")) {
                    JOptionPane
                            .showMessageDialog(null, "Error in text 'Name'");
                    return;
                    ...
                    DataBase.updateUser(Integer.parseInt(searchText), name, pass, address, city, email, phone);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ResultSet res = DataBase.RunSelect(null, "where id = " + searchText);
        try {
            String name, pass, address, city, email, phone;
            if (res.next()) {
